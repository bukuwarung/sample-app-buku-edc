...
## Why
Users need the Transfer action to open the multi-screen flow defined in Figma, instead of showing a toast only.
...
- Update Home action handling so Transfer navigates to the flow while other actions keep toast feedback.

## Impact
- Affected specs: `specs/home-mvvm/spec.md` (modified), new `specs/transfer-flow/spec.md`.
- Affected code: Home UI action handling, navigation setup, new Transfer screens and view models in the UI module.