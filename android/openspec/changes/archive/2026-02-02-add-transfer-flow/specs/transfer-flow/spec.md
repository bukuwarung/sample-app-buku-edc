...
The system SHALL present the Transfer flow screens in this order: Transfer (Choose Account), Pilih
Bank, Rekening Tujuan, Transfer (Insert Card), Transfer (Informasi Kartu), Masukkan PIN, Konfirmasi
...
The system SHALL provide a Hilt-injected ViewModel for each Transfer screen to supply UI state and
events.
