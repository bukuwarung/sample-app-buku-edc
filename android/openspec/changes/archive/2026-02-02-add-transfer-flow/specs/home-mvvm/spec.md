...
The system SHALL display a toast message for non-Transfer Home actions based on a view model UI
event.
...
The system SHALL emit a navigation event from the Home view model when the Transfer action is
tapped.
